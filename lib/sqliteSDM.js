...
const {makeOrmPreset, executeOrmObj} = require("./sqliteORM");
...
SDMResponse.prototype = {
	...
	// public
	getIdListPromise: function() {
		return Promise.all([this.obsIdPromise, this.onDonePromise]);
	},
